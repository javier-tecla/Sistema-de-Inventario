                                        ...
                                        <form action="{{ url('/admin/proveedores/create') }}" method="POST">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="empresa">Empresa <sup class="text-danger">(*)</sup></label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="direccion">Dirección <sup
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="telefono">Teléfono <sup
                                                            class="text-danger">(*)</sup></label>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><i
            ...
            $(function() {
                $("#example1").DataTable({
                    ...
                    "language": {
                        ...
                        "infoFiltered": "(Filtrado de_MAX_ total Proveedores)",
